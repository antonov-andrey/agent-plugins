...
- Git owns branches and commits. GitHub owns PR state, typed required-check results, classic/effective-ruleset protection and merge results. Protection is read for the exact repository/base and executing identity; absent, disabled, ineffective or bypassed protection is never accepted.
