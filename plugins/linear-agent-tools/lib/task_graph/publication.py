...
class GraphPublicationView:
    ...
    def payload(self) -> dict[str, object]:
        ...
        return {
            ...
            "issue_list": [_issue_payload(item) for item in self.issue_list],
...
def graph_publication_view_build(graph: TaskGraph) -> GraphPublicationView:
    ...
    issue_list = tuple(
        IssuePublication(
            ...
            title=node.title,
            description=issue_description_build(
                source=graph.source,
...
def delta_publication_view_build(delta: TaskGraphDelta) -> DeltaPublicationView:
...
def issue_description_build(
    *,
    ...
    Returns:
        Visible Markdown issue description.
    """
...
def _issue_payload(item: IssuePublication) -> dict[str, object]:
