...
from task_cleanup.model import CleanupRequest, PullRequestReference, PullRequestTarget, TaskCleanupError
        ...
        with IssueWorkspaceLock(self._config, request.issue_identifier):
            ...
            for origin_url, state in workspace_state_by_origin_url_map.items():
                if state is not None:
                    ...
                    self._absence_require(repository_by_origin_url_map[origin_url], request.issue_identifier)
            ...
            for origin_url, repository in repository_by_origin_url_map.items():
                ...
                if not state.cleanup_binding_completed:
                    ...
                    cleanup_binding_run(
                        ...
                        placeholder_by_name_map=_placeholder_map(request.issue_identifier, state),
                    )
